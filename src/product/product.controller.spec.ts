...
const productsList: Products[] = [
  new Products({ id: 1, name: 'produto 1', price: 10, type: ProductType.MARMITA, size: ProductSize.PEQUENA, description: 'teste', status: true, image: null, created_at: new Date(), updated_at: new Date(), orderToProducts: [] }),
  new Products({ id: 2, name: 'produto 2', price: 20, type: ProductType.MARMITA, size: ProductSize.MEDIA, description: 'teste', status: true, image: null, created_at: new Date(), updated_at: new Date(), orderToProducts: [] }),
  new Products({ id: 3, name: 'produto 3', price: 30, type: ProductType.MARMITA, size: ProductSize.GRANDE, description: 'teste', status: true, image: null, created_at: new Date(), updated_at: new Date(), orderToProducts: [] }),
];
