...
const additionsList: Addition[] = [
  new Addition({ id: 1, name: 'acréscimo 1', price: 10, status: true, created_at: new Date(), updated_at: new Date() }),
  new Addition({ id: 2, name: 'acréscimo 2', price: 20, status: true, created_at: new Date(), updated_at: new Date() }),
  new Addition({ id: 3, name: 'acréscimo 3', price: 30, status: true, created_at: new Date(), updated_at: new Date() }),
];
...
describe('Register Controller', () => {
      ...
      providers: [
        {
          ...
          useValue: {
            create: jest.fn().mockResolvedValue(
              new Addition({ id: 4, name: 'acréscimo 4', price: 40, status: true, created_at: new Date(), updated_at: new Date() }),
            ),
  ...
  describe('create', () => {
    it('should return a save addition successfully', async () => {
      const addition = new Addition({ id: 4, name: 'acréscimo 4', price: 40, status: true, created_at: new Date(), updated_at: new Date() });
